  ...
  return(
    <Box >
      ...
      <Typography textAlign='left' sx = {{ml: '10px'}}>
        ...
        <br></br>
        I spent my childhood a lot differently than the average child in the 2010’s. I had unlimited screen time and internet access, the best thing ever.. In 2011, I created a sports blog where I discovered HTML. I used HTML to design my blog. Using templates at first and then finding that the templates didn’t match my ultimate vision, I began making tiny adjustments that led to huge adjustments. This was my first taste of coding. 
        <br></br>
        <br></br>
